(function(a){var f=a(".multibrowse"),g=a(".mb_submit"),k=a(".mb_reset"),d=a(".multibrowse input:file"),p=d.filter(":first").prop("attributes"),l=0,q={maxNumberOfInputs:f.attr("mb-inputs-max"),maxFileSize:a("input[name='MAX_FILE_SIZE']").attr("value"),maxTotalSize:f.attr("mb-total-size"),previewWidth:f.attr("mb-preview-width")};g[0].disabled=!1;a.fn.addFileInput=function(b){var c=a.extend({maxNumberOfInputs:3,maxFileSize:2E6,maxTotalSize:2E6,previewWidth:200},b);f.on("change","input:file",function(){d=
